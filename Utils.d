...
/+++ TODO
 +
 +  Get the old CreatePoolingFunction
 +  Replace the delegate reducer by an alias (a, b) => ...
 +  Remove CellRange -> it should not exist
 +  Remove FrameRAnge -> it should not exist
 +
 +
 +  Everything should be more difficult to understand but faster 
 +/
...
/++ Function that create a general pooling function
 ...
 +/
@safe @nogc @pure
auto createPoolingFunction(T, size_t height, size_t width,
                              ...
                              alias reducer)()
{
    /+  This function create a delegate.
        ...
        Args:
            ...
            reducer (function(a, b)): Function that takes an CellRange
...
unittest {
    write("                 takeOwnership_util (T[], T(], size_t))... ");
